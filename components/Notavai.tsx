      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-row items-center justify-between w-full max-w-4xl p-4">
          ...
          <div className="flex-2 text-center ml-4">
            <h2 className="text-3xl font-bold mb-4 text-white" style={{ fontFamily: 'Balthazar, sans-serif' }}>Content Not Available</h2>
            <p className="mb-4 text-white" style={{ fontFamily: 'Titillium Web, sans-serif' }}>We are working! Please check back later.</p>
            <Link href="/">
